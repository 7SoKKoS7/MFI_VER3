...
- **Medium Pivot (Mid) = (PH + PL) / 2** — ось клинча; используется как фильтр внутри диапазона
...
- **Pivot H1: H=1.23456 | M=1.22900 | L=1.22345** — уровни пивотов (M выводится, если есть валидные H и L)
