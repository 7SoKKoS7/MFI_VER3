...
### Система MF-pivot
- **PivotHigh/PivotLow/Medium Pivot** — три типа подтвержденных уровней
- **PivotHigh/PivotLow** — основные уровни поддержки/сопротивления
- **Medium Pivot** — уровень фиксации клинча (бокового движения)
...
- **Pivot H1: High=1.23456 | Low=1.22345 | Medium=1.22900** — уровни пивотов
